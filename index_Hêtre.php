  ...
  <body>
    ...
    <?php include "entete.inc.php" ?>
      ...
      <div class="col s12"><h1><?php echo "L'hêtre" ?></h1></div>
    ...
    <?php echo "Le Hêtre commun, Fagus sylvatica, couramment désigné simplement comme le hêtre est une espèce d'arbres à feuilles caduques, indigène d'Europe, appartenant à la famille des Fagaceae, tout comme le chêne et le châtaignier.
